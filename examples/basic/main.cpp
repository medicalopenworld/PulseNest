...
//
// Minimal example showing how to integrate incunest_afe4490 into an application.
...
//      other devices.
//   2. afe.begin() configures the chip, attaches the DRDY ISR and starts an
...
void setup() {
    ...
    // afe.setLED2Current(10.0f);  // RED LED, mA
