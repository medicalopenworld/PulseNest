...
| `10:51:DB:50:88:50` | V18 | 18.A | `sdkconfig.board.V18` | 2026-09-18 | OTA 2026-09-18 to `build=7770c6c`, `elfsha=a60928ae2b710aab`; **OTA 2026-09-20 to fw 0.14, `build=26c4f55`, `elfsha=accaa122c71f6108`** (Ts_us as `%llu`). Previously flashed and verified 2026-09-10; **OTA 2026-09-22 to fw 0.15 / lib 0.94, `build=da3cc94`, `elfsha=0154b6e792e5323f`** ($CFG `cause=hgac` per HGAC RF move; verified by `$CFG?` through the hub) |
